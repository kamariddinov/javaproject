...
public class PrintTicket1 extends JFrame
{
	public PrintTicket1(String sFrom, String sTo, String sClass, Integer iAdult, Integer iChildren, Integer iInfant, String sBookingDate, Integer iPrice, String sTime)
	{
		...
		JLabel LTicketNo=new JLabel("<html><font color=\"#000000\">TicketNumber: </font><font color=\"778899\">34143</font></html>");
		JLabel LBookedBy=new JLabel("<html><font color=\"#000000\">BookedBy: </font><font color=\"778899\">admin</font></html>");

		JLabel LEmpty = new JLabel("---------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
		JLabel LDemo = new JLabel("<html><U><font color=\"#8FBC8F\">AirLine-Project Developed By</font></U></html>");
		JLabel LAzamat=new JLabel("<html><I><font color=\"#8FBC8F\">Azamat</font></I></html>");
		JLabel LKhumoyiddin=new JLabel("<html><I><font color=\"#8FBC8F\">Khumoyiddin</font></I></html>");
		JLabel LIsmoil=new JLabel("<html><I><font color=\"#8FBC8F\">Ismoil</font></I></html>");
		JLabel LKamron=new JLabel("<html><I><font color=\"#8FBC8F\">Kamron</font></I></html>");
		JLabel LSohib=new JLabel("<html><I><font color=\"#8FBC8F\">Sohib</font></I></html>");
		...
		LAzamat.setBounds(285,485,300,20);
		LKhumoyiddin.setBounds(285,505,300,20);
		LIsmoil.setBounds(285,525,300,20);
		LKamron.setBounds(285,545,300,20);
		LSohib.setBounds(285,565,300,20);
